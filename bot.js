// ================================================================= //
// == SALIN DAN TEMPEL SELURUH KODE DI BAWAH INI KE FILE bot.js == //
// ================================================================= //
...
// --- BAGIAN 2: PENGATURAN & VARIABEL GLOBAL ---
...
// --- BAGIAN 3: KONSTANTA TEKS & DATA (BANK DOA, KOTA, MENU, DLL) ---
const PRAYER_NAMES_MAP = { Fajr: 'Subuh', Sunrise: 'Syuruk', Dhuhr: 'Dzuhur', Asr: 'Ashar', Maghrib: 'Maghrib', Isha: 'Isya', Imsak: 'Imsak', Sunset: 'Terbenam', Midnight: 'Tengah Malam', Firstthird: '⅓ Malam Awal', Lastthird: '⅓ Malam Akhir' };
const DOA_HARIAN = [ "Jangan takut melangkah hari ini. Setiap langkahmu, sekecil apa pun, adalah bagian dari perjalanan hebat. Semoga Allah SWT mudahkan. Semangat! 🔥", "Jika kamu merasa lelah, ingatlah bahwa istirahat adalah bagian dari perjuangan. Pejamkan matamu sejenak, berdoa, lalu lanjutkan dengan kekuatan baru. Kamu bisa! 💪", "Kegagalan hari ini adalah pelajaran untuk kemenangan esok hari. Jangan menyerah, terus perbaiki diri. Kamu lebih kuat dari yang kamu kira! 🚀", "Waktu terus berjalan. Manfaatkan setiap detiknya untuk hal yang mendekatkanmu pada-Nya dan pada impianmu. Waktumu berharga! ⏳", "Semangat kerjanya! Niatkan setiap usahamu sebagai ibadah, maka lelahmu akan menjadi pahala yang tak terhingga. Bismillah! 💼", "Cita-citamu besar? Bagus! Iringi dengan doa yang besar dan usaha yang tak kalah besar. Allah SWT Maha Mendengar. 🎯", "Hari esok masih misteri. Hari kemarin adalah kenangan. Hari ini adalah anugerah. Lakukan yang terbaik di hari ini! 🎁", "Setiap ujian yang datang tidak pernah melebihi batas kemampuanmu. Allah SWT tahu kamu kuat. Hadapi dengan sabar dan sholat. 🙏", "Jangan biarkan keraguan menghentikanmu. Ucapkan 'Bismillah', lalu langkahkan kakimu. Allah SWT akan membuka jalan bagi mereka yang berusaha. ✨", "Ingat, kamu tidak harus menjadi hebat untuk memulai, tapi kamu harus memulai untuk menjadi hebat. Langkah pertama hari ini adalah kuncinya. 🔑", "Energi pagimu menentukan sisa harimu. Buka hari dengan doa dan optimisme, insyaAllah hasilnya akan luar biasa. Kamu siap? 🔥", "Saat kamu merasa ingin menyerah, ingat kembali alasan mengapa kamu memulai. Tujuanmu lebih besar dari rintanganmu saat ini. Terus maju! 🚶‍♂️🚶‍♀️", "Kesalahan bukan akhir dari segalanya, melainkan guru terbaik. Belajar, bangkit, dan jadilah versi dirimu yang lebih baik hari ini. 🌱", "Fokus pada kemajuan, bukan kesempurnaan. Setiap progres, sekecil apapun, layak untuk dirayakan. Kamu sudah melakukan yang terbaik! 🏆", "Dunia mungkin tidak selalu adil, tapi usaha dan doa tidak pernah sia-sia di mata Allah SWT. Teruslah berjuang dengan cara yang baik. 💖", "Ubah 'aku tidak bisa' menjadi 'aku akan coba'. Kekuatan pikiran dan doa bisa memindahkan gunung. Yakinlah! ⛰️", "Untuk setiap pintu yang tertutup, percayalah Allah SWT telah menyiapkan pintu lain yang lebih baik untukmu. Jangan berhenti mencari. 🚪", "Jangan menunggu motivasi datang, ciptakan motivasimu sendiri. Mulai dari hal kecil, selesaikan, dan rasakan kepuasannya. Lanjutkan! ✨", "Jadilah produktif, bukan hanya sibuk. Tentukan prioritasmu hari ini dan fokuslah pada hal yang benar-benar penting. Kamu pasti bisa! ✅", "Kekuatan terbesar ada setelah kamu berhasil melewati kelemahan terbesarmu. Hadapi tantangan hari ini, kamu akan jadi lebih kuat. 💪", "Pernahkah kamu berhenti sejenak hanya untuk bersyukur atas nafas hari ini? Alhamdulillah... Semoga sisa harimu dipenuhi ketenangan. 🙏", "Rezeki bukan hanya soal materi, tapi juga teman yang baik dan hati yang damai. Semoga hari ini kita dikelilingi oleh keduanya. Aamiin. 🌿", "Jangan bandingkan dirimu dengan orang lain. Bunga mawar dan matahari tidak bisa dibandingkan, keduanya indah dengan caranya sendiri. Begitu juga kamu. 🌷", "Saat semua terasa berat, coba lihat ke atas. Ada Allah SWT yang Maha Besar. Masalahmu tidak ada apa-apanya bagi-Nya. Mintalah pertolongan. ✨", "Lihat sekelilingmu. Ada begitu banyak nikmat kecil yang sering terlupakan. Udara yang kita hirup, air yang kita minum. Alhamdulillah 'ala kulli haal. 💨", "Jangan menunggu bahagia untuk bersyukur, tapi bersyukurlah, maka kebahagiaan akan datang menghampirimu. Kuncinya adalah syukur. 😊", "Ucapkanlah 'Alhamdulillah' setidaknya 5 kali sekarang. Rasakan getaran syukurnya di dalam hati. Nikmat mana lagi yang kau dustakan? 💖", "Terkadang Allah SWT menahan sesuatu darimu bukan untuk menghukum, tapi untuk melindungimu. Ucapkan Alhamdulillah atas apa yang tidak kamu miliki. 🙏", "Hidup ini singkat. Jangan habiskan dengan keluhan. Habiskan dengan syukur, doa, dan usaha untuk menjadi lebih baik. ⏳", "Setiap pagi adalah halaman baru dalam buku kehidupanmu. Tulislah cerita yang indah hari ini, dimulai dengan rasa syukur. 📖", "Sudahkah kamu berterima kasih pada dirimu sendiri hari ini? Terima kasih telah bertahan, berjuang, dan tidak menyerah. Kamu hebat! 🤗", "Melihat ke atas untuk motivasi, melihat ke bawah untuk bersyukur. Keseimbangan ini akan membuat hatimu selalu damai. ⚖️", "Nikmat sehat adalah mahkota di kepala orang sehat yang hanya bisa dilihat oleh orang sakit. Syukuri sehatmu hari ini. 💚", "Jangan terlalu khawatirkan masa depan hingga lupa mensyukuri hari ini. Hari ini adalah anugerah nyata yang ada di tanganmu. ✨", "Semakin banyak kamu bersyukur, semakin banyak hal yang akan datang untuk kamu syukuri. Jadikan syukur sebagai kebiasaanmu. 🌿", "Saat kamu merasa tidak punya apa-apa, ingatlah kamu punya Allah SWT. Dan itu sudah lebih dari cukup. Alhamdulillah. ❤️", "Mungkin doamu belum terkabul, tapi lihatlah berapa banyak nikmat yang Allah SWT berikan tanpa kamu minta. Dia Maha Tahu yang terbaik. 🙏", "Harta yang paling berharga adalah keluarga yang hangat dan teman yang tulus. Syukuri kehadiran mereka dalam hidupmu. 👨‍👩‍👧‍👦", "Kesulitan adalah cara Allah SWT memberitahu bahwa kamu sedang dirindukan dalam sujud dan doamu. Dekati Dia. ✨", "Satu tarikan nafas adalah anugerah. Gunakan ia untuk berdzikir, memuji nama-Nya. Subhanallah, Walhamdulillah, Walaa Ilaha Illallah, Wallahu Akbar. 💨", "Satu kebaikan kecil hari ini bisa menjadi alasan senyum orang lain. Sudahkah kamu berbagi kebaikan hari ini? Yuk, tebar senyum! 😄", "Apapun yang sedang kamu hadapi, ingatlah: 'Laa tahzan, innallaha ma'ana' (Jangan bersedih, sesungguhnya Allah SWT beserta kita). Kamu tidak sendirian. ❤️", "Tersenyumlah! Senyummu adalah sedekah termudah, obat terbaik untuk dirimu sendiri, dan cahaya bagi orang di sekitarmu. Coba sekarang! 😊", "Jika ada yang menyakitimu, balaslah dengan doa. Mendoakan kebaikan untuk orang lain adalah cara terbaik membersihkan hati. 💖", "Sudahkah kamu memaafkan seseorang hari ini? Memaafkan membebaskan dua jiwa: jiwamu dan jiwa orang itu. Hati yang lapang adalah sumber kebahagiaan. 🤗", "Semoga hari ini, kita lebih banyak mendengar daripada berbicara, lebih banyak memberi daripada meminta, dan lebih banyak bersyukur daripada mengeluh. Aamiin. 🌿", "Jadilah seperti akar, tak terlihat namun menjadi sumber kekuatan bagi pohon untuk tumbuh tinggi. Ikhlaslah dalam setiap kebaikan. 🌳", "Semoga kita dijauhkan dari sifat sombong dan iri hati. Semoga hati kita selalu bersih dan dipenuhi kasih sayang. Aamiin. 🕊️", "Kebaikan itu menular. Mulailah dari dirimu, dan lihat bagaimana energi positif itu menyebar ke sekelilingmu. ✨", "Jadilah pribadi yang pemaaf. Dendam itu berat, hanya akan membebani langkahmu. Memaafkan itu ringan dan melapangkan. 🎈", "Saat kamu merasa sendirian, ingatlah Allah SWT sedang memberimu kesempatan untuk berbicara hanya dengan-Nya. Manfaatkan momen itu. 🌙", "Ketenangan sejati bukan saat tidak ada masalah, tapi saat hatimu tetap terhubung dengan Allah SWT di tengah badai masalah. 🙏", "Jangan biarkan perlakuan buruk orang lain merusak kedamaian hatimu. Balas dengan diam, doa, dan kebaikan. Kamu lebih mulia. ✨", "Menjadi orang baik tidak menjamin semua orang akan menyukaimu, tapi itu menjamin Allah SWT akan menyukaimu. Dan itu yang terpenting. ❤️", "Hati yang tenang adalah istana termewah. Jagalah ia dari pikiran negatif dan prasangka buruk. Hiasi dengan dzikir. 👑", "Bantu orang lain tanpa pamrih, maka Allah SWT akan membantumu dari arah yang tak terduga. Tangan di atas lebih baik dari tangan di bawah. 🤝", "Hindari perdebatan yang tidak perlu. Mengalah bukan berarti kalah, terkadang itu adalah kemenangan untuk kedamaian hatimu. 🤫", "Bicara yang baik atau diam. Lisanmu mencerminkan hatimu. Semoga lisan kita selalu basah karena dzikir dan kata-kata yang menyejukkan. 💬", "Setiap jiwa butuh ketenangan. Temukan ketenanganmu dalam sholat, dalam Al-Qur'an, dan dalam mengingat-Nya. 💖", "Sebarkan salam. 'Assalamualaikum' bukan hanya sapaan, tapi doa. Semoga keselamatan, rahmat, dan berkah-Nya menyertaimu. 🙏", "Semoga makanan yang kamu nikmati hari ini menjadi sumber energi untuk beribadah dan berbuat baik. Jangan lupa Bismillah. 🍽️", "Semoga setiap tetes keringat yang jatuh dalam usahamu mencari rezeki halal, menjadi saksi perjuanganmu di hadapan-Nya kelak. Aamiin. 💧", "Satu sedekah kecil di pagi hari bisa menolak bala dan membuka pintu rezeki. Sudahkah kamu bersedekah hari ini? 💸", "Semoga Allah SWT selalu menuntun langkah kita ke tempat-tempat yang baik, bertemu orang-orang yang baik, dan melakukan hal-hal yang baik. 🚶‍♂️🚶‍♀️", "Ya Allah, cukupkan kebutuhan kami, lapangkan rezeki kami, dan berkahi setiap apa yang kami miliki. Aamiin Ya Rabbal Alamin. ✨", "Pintu rezeki bukan hanya dari bekerja, tapi juga dari bakti pada orang tua, dari silaturahmi, dan dari sedekah. Mari kita buka semua pintunya. 🚪", "Jangan khawatirkan rezekimu. Ia sudah diatur dan tidak akan pernah tertukar. Khawatirkan amalanmu, karena itu bekalmu. 🙏", "Jika Allah SWT menahan rezekimu, mungkin Dia ingin memberimu yang lebih baik di waktu yang tepat. Teruslah berprasangka baik dan berusaha. ✨", "Kunci rezeki yang paling ampuh adalah sholat tepat waktu dan istighfar. Mari kita amalkan keduanya hari ini. 🔑", "Ya Allah, kami memohon kepada-Mu ilmu yang bermanfaat, rezeki yang baik, dan amal yang diterima. Aamiin. 🤲", "Rezeki yang paling nikmat adalah saat ia menjadi jalan untuk kita lebih banyak beribadah dan membantu sesama. Semoga rezeki kita berkah. 🌿", "Jangan hanya mengejar dunia, nanti kamu lelah. Libatkan Allah SWT, maka dunia yang akan mengejarmu. Bismillah. 🚀", "Setiap makhluk hidup di bumi sudah dijamin rezekinya. Tugas kita hanya menjemputnya dengan cara yang halal dan diridhai-Nya. 🐾", "Mengeluh tidak akan menambah rezekimu, tapi bersyukur akan mengundangnya datang. Yuk, ganti keluhan dengan Alhamdulillah. 😊", "Kadang kemudahan datang setelah kita memudahkan urusan orang lain. Mari saling membantu hari ini. 🤝", "Ya Allah, jauhkan kami dari hutang yang memberatkan dan rezeki yang haram. Berikan kami kecukupan dan keberkahan. Aamiin. 🙏", "Jangan lupa istighfar. Mungkin ada pintu rezeki yang tertahan karena dosa kecil yang tak kita sadari. Astaghfirullahaladzim...", "Sebuah pengingat lembut: Sudahkah kamu mendoakan kedua orang tuamu hari ini? Mereka adalah sumber keberkahan terbesarmu. 🤲", "Satu ayat Al-Qur'an yang dibaca dengan tulus bisa menenangkan hati yang paling gelisah. Sudahkah kamu menyapa Kalam-Nya hari ini? 📖", "Ingat, sholat bukan hanya kewajiban, tapi kebutuhan. Itu adalah waktu istirahatmu bersama Sang Pencipta. Nikmatilah setiap gerakannya. 🙏", "Pengingat sholat Dhuha: Dua rakaat di pagi hari sebagai tanda syukur, insyaAllah membuka pintu-pintu rezeki. Sudahkah kamu? 😊", "Berbaktilah kepada orang tua selagi mereka ada. Ridha Allah SWT terletak pada ridha mereka. Sudahkah kamu menelepon mereka hari ini? 📞", "Jangan biarkan kesibukan dunia melupakanmu dari tujuan akhirmu: Surga. Mari seimbangkan dunia dan akhirat kita. ⚖️", "Mari kita perbanyak shalawat hari ini. Semoga kita semua mendapatkan syafaat dari Rasulullah SAW di hari akhir kelak. Allahumma shalli 'ala sayyidina Muhammad. ❤️", "Saat adzan berkumandang, tinggalkan sejenak urusan duniamu. Panggilan itu lebih penting dari panggilan mana pun. Yuk, siapkan diri. 🙏", "Al-Kahfi di hari Jumat adalah cahaya di antara dua Jumat. Jangan lupa membacanya atau mendengarkannya nanti ya. ✨" ];
const KOTA_VALID = new Set(['aceh besar', 'aceh barat', 'aceh barat daya', 'aceh jaya', 'aceh selatan', 'aceh singkil', 'aceh tamiang', 'aceh tengah', 'aceh tenggara', 'aceh timur', 'aceh utara', 'nias', 'nias selatan', 'nias utara', 'nias barat', 'mandailing natal', 'tapanuli selatan', 'tapanuli tengah', 'tapanuli utara', 'toba samosir', 'samosir', 'labuhanbatu', 'labuhanbatu selatan', 'labuhanbatu utara', 'asahan', 'simalungun', 'dairi', 'karo', 'deli serdang', 'langkat', 'serdang bedagai', 'batu bara', 'padang lawas', 'padang lawas utara', 'pakpak bharat', 'humbang hasundutan', 'kepulauan mentawai', 'pesisir selatan', 'solok', 'sijunjung', 'tanah datar', 'padang pariaman', 'agam', 'lima puluh kota', 'pasaman', 'pasaman barat', 'dharmasraya', 'kampar', 'indragiri hulu', 'bengkalis', 'indragiri hilir', 'pelalawan', 'rokan hulu', 'rokan hilir', 'siak', 'kepulauan meranti', 'kerinci', 'merangin', 'sarolangun', 'batanghari', 'muaro jambi', 'tanjung jabung timur', 'tanjung jabung barat', 'tebo', 'bungo', 'oku', 'ogan komering ulu', 'ogan komering ilir', 'muara enim', 'lahat', 'musi rawas', 'musi banyuasin', 'banyuasin', 'oku selatan', 'oku timur', 'ogan ilir', 'empat lawang', 'penukal abab lematang ilir', 'musi rawas utara', 'bengkulu selatan', 'rejang lebong', 'bengkulu utara', 'kaur', 'seluma', 'muko muko', 'lebong', 'kepahiang', 'bengkulu tengah', 'lampung barat', 'tanggamus', 'lampung selatan', 'lampung timur', 'lampung tengah', 'lampung utara', 'way kanan', 'tulang bawang', 'pesawaran', 'pringsewu', 'mesuji', 'tulang bawang barat', 'pesisir barat', 'bangka', 'belitung', 'bangka barat', 'bangka tengah', 'bangka selatan', 'belitung timur', 'karimun', 'bintan', 'natuna', 'lingga', 'kepulauan anambas', 'banda aceh', 'sabang', 'lhokseumawe', 'langsa', 'subulussalam', 'medan', 'pematangsiantar', 'sibolga', 'tanjungbalai', 'binjai', 'tebing tinggi', 'padangsidimpuan', 'gunungsitoli', 'padang', 'sawah lunto', 'padang panjang', 'bukittinggi', 'payakumbuh', 'pariaman', 'pekanbaru', 'dumai', 'jambi', 'sungai penuh', 'palembang', 'prabumulih', 'pagar alam', 'lubuklinggau', 'bengkulu', 'bandar lampung', 'metro', 'pangkal pinang', 'batam', 'tanjung pinang', 'kepulauan seribu', 'jakarta pusat', 'jakarta utara', 'jakarta barat', 'jakarta selatan', 'jakarta timur', 'cianjur', 'bandung', 'garut', 'tasikmalaya', 'ciamis', 'kuningan', 'cirebon', 'majalengka', 'sumedang', 'indramayu', 'subang', 'purwakarta', 'karawang', 'bandung barat', 'pangandaran', 'cilacap', 'banyumas', 'purbalingga', 'banjarnegara', 'kebumen', 'purworejo', 'wonosobo', 'magelang', 'boyolali', 'klaten', 'sukoharjo', 'wonogiri', 'karanganyar', 'sragen', 'grobogan', 'blora', 'rembang', 'pati', 'kudus', 'jepara', 'demak', 'semarang', 'temanggung', 'kendal', 'batang', 'pekalongan', 'pemalang', 'tegal', 'brebes', 'kulon progo', 'bantul', 'gunung kidul', 'sleman', 'pacitan', 'ponorogo', 'trenggalek', 'tulungagung', 'blitar', 'kediri', 'malang', 'lumajang', 'jember', 'banyuwangi', 'bondowoso', 'situbondo', 'probolinggo', 'pasuruan', 'sidoarjo', 'mojokerto', 'jombang', 'nganjuk', 'madiun', 'magetan', 'ngawi', 'bojonegoro', 'tuban', 'lamongan', 'gresik', 'bangkalan', 'sampang', 'pamekasan', 'sumenep', 'depok', 'cimahi', 'banjar', 'surakarta', 'solo', 'salatiga', 'surabaya', 'batu', 'pandeglang', 'lebak', 'tangerang', 'serang', 'cilegon', 'tangerang selatan', 'sambas', 'bengkayang', 'landak', 'mempawah', 'sanggau', 'ketapang', 'sintang', 'kapuas hulu', 'sekadau', 'melawi', 'kayong utara', 'kubu raya', 'kotawaringin barat', 'kotawaringin timur', 'kapuas', 'barito selatan', 'barito utara', 'sukamarau', 'lamandau', 'seruyan', 'katingan', 'pulang pisau', 'gunung mas', 'barito timur', 'murung raya', 'tanah laut', 'kotabaru', 'barito kuala', 'tapin', 'hulu sungai selatan', 'hulu sungai tengah', 'hulu sungai utara', 'tabalong', 'tanah bumbu', 'balangan', 'paser', 'kutai barat', 'kutai kartanegara', 'kutai timur', 'berau', 'penajam paser utara', 'mahakam hulu', 'malinau', 'bulungan', 'tana tidung', 'nunukan', 'pontianak', 'singkawang', 'palangkaraya', 'palangka raya', 'banjarmasin', 'banjarbaru', 'samarinda', 'balikpapan', 'bontang', 'tarakan', 'jembrana', 'tabanan', 'badung', 'gianyar', 'klungkung', 'bangli', 'karangasem', 'buleleng', 'lombok barat', 'lombok tengah', 'lombok timur', 'sumbawa', 'dompu', 'bima', 'sumbawa barat', 'lombok utara', 'sumba barat', 'sumba timur', 'timor tengah selatan', 'timor tengah utara', 'belu', 'alor', 'lembata', 'flores timur', 'sikka', 'ende', 'ngada', 'manggarai', 'rote ndao', 'manggarai barat', 'sumba tengah', 'sumba barat daya', 'nagekeo', 'manggarai timur', 'sabu raijua', 'malaka', 'denpasar', 'mataram', 'kupang', 'kepulauan selayar', 'bulukumba', 'bantaeng', 'jeneponto', 'takalar', 'gowa', 'sinjai', 'maros', 'pangkajene dan kepulauan', 'barru', 'bone', 'soppeng', 'wajo', 'sidenreng rappang', 'pinrang', 'enrekang', 'luwu', 'tana toraja', 'luwu utara', 'luwu timur', 'toraja utara', 'donggala', 'poso', 'morowali', 'banggai', 'buol', 'toli-toli', 'parigi moutong', 'tojo una-una', 'sigi', 'banggai kepulauan', 'morowali utara', 'banggai laut', 'bolaang mongondow', 'minahasa', 'kepulauan sangihe', 'kepulauan talaud', 'minahasa selatan', 'minahasa utara', 'minahasa tenggara', 'bolaang mongondow utara', 'kepulauan siau tagulandang biaro', 'bolaang mongondow timur', 'bolaang mongondow selatan', 'konawe', 'muna', 'buton', 'kolaka', 'konawe selatan', 'bombana', 'wakatobi', 'kolaka utara', 'buton utara', 'konawe utara', 'kolaka timur', 'konawe kepulauan', 'muna barat', 'buton tengah', 'buton selatan', 'boalemo', 'gorontalo', 'pohuwato', 'bone bolango', 'gorontalo utara', 'majene', 'polewali mandar', 'mamasa', 'mamuju', 'pasangkayu', 'mamuju tengah', 'makassar', 'parepare', 'palopo', 'palu', 'manado', 'bitung', 'tomohon', 'kotamobagu', 'kendari', 'baubau', 'maluku tenggara barat', 'maluku tenggara', 'maluku tengah', 'buru', 'kepulauan aru', 'seram bagian barat', 'seram bagian timur', 'kepulauan tanimbar', 'buru selatan', 'halmahera barat', 'halmahera tengah', 'kepulauan sula', 'halmahera selatan', 'halmahera utara', 'halmahera timur', 'pulau morotai', 'pulau taliabu', 'fakfak', 'kaimana', 'teluk wondama', 'teluk bintuni', 'manokwari', 'sorong selatan', 'raja ampat', 'tambrauw', 'maybrat', 'manokwari selatan', 'pegunungan arfak', 'merauke', 'jayawijaya', 'jayapura', 'nabire', 'kepulauan yapen', 'biak numfor', 'paniai', 'puncak jaya', 'mimiika', 'boven digoel', 'mapi', 'asmat', 'yahukimo', 'pegunungan bintang', 'tolikara', 'sarmi', 'keerom', 'waropen', 'supiori', 'mamberamo raya', 'nduga', 'lanny jaya', 'mamberamo tengah', 'yalimo', 'puncak', 'dogiyai', 'intan jaya', 'deiyai', 'ambon', 'tual', 'ternate', 'tidore kepulauan', 'sorong', 'bekasi', 'bogor', 'sukabumi' ]);
...
// --- BAGIAN 4: FUNGSI-FUNGSI HELPER (TIDAK DIUBAH) ---
const generateMenuText = (userName, totalPersonal, totalGroup, isGroup = false) => { const dynamicWishes = ["Allah SWT selalu melimpahkan rahmat dan berkah-Nya di setiap langkahmu hari ini. 🤲", "menjadi awal yang penuh kemudahan dan keberkahan dari Allah SWT. 🤲", "Allah SWT mengisi pagimu dengan ketenangan dan hati yang penuh syukur. 🤲", "Allah SWT melindungimu dari segala mara bahaya dan menjadikan harimu penuh kebaikan. 🤲", "setiap doamu dikabulkan dan setiap usahamu diberi keberhasilan oleh Allah SWT. 🤲", "Allah SWT memberimu kekuatan dan kesabaran dalam menjalani hari yang baru ini. 🤲", "Allah SWT limpahkan kebahagiaan dan kedamaian dalam hatimu hari ini. 🤲", "segala urusanmu hari ini dimudahkan dan diberkahi oleh Allah SWT. 🤲", "cahaya iman dan taqwa menerangi langkahmu sepanjang hari ini. 🤲", "Allah SWT mengampuni dosa-dosamu dan menerima amal ibadahmu hari ini. 🤲", "hatimu selalu dipenuhi dengan rasa syukur dan cinta kepada Allah SWT. 🤲", "Allah SWT jadikan pagimu ini sebagai awal kesuksesan dan kebahagiaan. 🤲", "setiap nafas yang kau hirup hari ini membawa berkah dan rahmat Allah SWT. 🤲", "Allah SWT menuntunmu pada jalan yang lurus dan penuh keberkahan. 🤲", "harimu dipenuhi dengan kebaikan yang mengalir dari rahmat Allah SWT. 🤲", "Allah SWT bukakan pintu rezeki yang halal dan berkah untukmu hari ini. 🤲", "setiap langkahmu hari ini mendapat ridha dan kasih sayang Allah SWT. 🤲", "Allah SWT jauhkanmu dari segala kesulitan dan ujian yang berat hari ini. 🤲", "Allah SWT jadikan pagimu penuh dengan dzikir dan pengingat kebaikan. 🤲", "keberkahan dan ampunan Allah SWT selalu menyertai setiap aktivitasmu hari ini. 🤲", "semua urusanmu dilancarkan dan penuh berkah. 🤲", "hatimu dipenuhi ketenangan dan kebahagiaan. 🤲", "langkahmu selalu dalam lindungan-Nya. 🤲", "hari ini membawa rezeki yang tak terduga untukmu. 🤲", "setiap lelahmu menjadi lillah dan bernilai ibadah. 🤲", "kamu dan keluarga senantiasa diberi kesehatan. 🤲", "ilmu yang kamu pelajari hari ini menjadi manfaat dunia dan akhirat. 🤲", "senyummu hari ini menjadi pembuka pintu rezeki. 🤲", "setiap doamu hari ini diijabah oleh-Nya. 🤲"]; const randomWish = dynamicWishes[Math.floor(Math.random() * dynamicWishes.length)]; const nowInJakarta = DateTime.now().setZone('Asia/Jakarta'); const hour = nowInJakarta.hour; let timeOfDayGreeting = ""; let timeOfDayEmoji = ""; if (hour >= 4 && hour < 10) { timeOfDayGreeting = "Selamat pagi"; timeOfDayEmoji = "☀️"; } else if (hour >= 10 && hour < 15) { timeOfDayGreeting = "Selamat siang"; timeOfDayEmoji = "🌤️"; } else if (hour >= 15 && hour < 18) { timeOfDayGreeting = "Selamat sore"; timeOfDayEmoji = "🌇"; } else { timeOfDayGreeting = "Selamat malam"; timeOfDayEmoji = "🌙"; } const fullDate = nowInJakarta.setLocale('id').toFormat('cccc, dd MMMM yyyy'); const openingGreeting = isGroup ? `Assalamualaikum semuanya! ${timeOfDayGreeting} ${timeOfDayEmoji}` : `Assalamualaikum, *${userName}*! ${timeOfDayGreeting} ${timeOfDayEmoji}`; const openingWish = `Semoga di hari ${fullDate} ini, ${randomWish}`; const openingAction = "Berikut adalah daftar perintah yang bisa kamu gunakan:"; const finalOpening = `${openingGreeting}\n\n${openingWish}\n\n${openingAction}`; const serverTime = nowInJakarta.toFormat('HH:mm:ss'); const timeZoneString = `GMT+07:00 (WIB)`; return (`${finalOpening}\n\n` + "*📖 MENU UTAMA*\n" + " `/aturpengingat` - Berlangganan pengingat waktu Sholat\n" + " `/gantilokasi` - Ubah lokasi pengingat\n" + " `/berhenti` - Berhenti langganan pengingat\n" + " `/jadwal` - Cek jadwal waktu Sholat\n" + " `/randomayat` - Random Ayat Al Qur'an\n\n" + "*ℹ️ BANTUAN & INFO*\n" + " `/infobot` - Lihat status dan info bot\n" + " `/kota` - Lihat daftar kota\n" + " `/panduan` - Informasi & Cara penggunaan bot\n" + " `/donasi` - Dukung pengembangan bot\n" + " `/owner` - Hubungi pemilik bot\n\n\n" + `> Server Time: ${serverTime} ${timeZoneString}\n` + "> © MUADZIN BOT"); };
function loadData(filePath, defaultValue) { try { if (fs.existsSync(filePath)) { const data = fs.readFileSync(filePath, 'utf-8'); return JSON.parse(data); } } catch (error) { console.error(`[ERROR] Gagal memuat file ${filePath}:`, error); } return defaultValue; }
function saveData(filePath, data) { try { fs.writeFileSync(filePath, JSON.stringify(data, null, 2)); } catch (error) { console.error(`[ERROR] Gagal menyimpan file ${filePath}:`, error); } }
function loadInitialData() { subscribers = loadData(SUBSCRIBERS_FILE, {}); const blockedArray = loadData(BLOCKED_USERS_FILE, []); blockedUsers = new Set(blockedArray); console.log('[INFO] Berhasil memuat data pelanggan dan pengguna yang diblokir.'); }
async function fetchPrayerTimes(city, date = new Date()) { const formattedDate = `${date.getDate()}-${date.getMonth() + 1}-${date.getFullYear()}`; try { const response = await axios.get(`http://api.aladhan.com/v1/timingsByCity/${formattedDate}`, { params: { city: city, country: "Indonesia", method: 11 } }); if (!response.data || response.data.code !== 200) { console.log(`[VALIDASI GAGAL] API tidak merespons dengan baik untuk kota: ${city}`); return null; } const responseData = response.data.data; if (!responseData || !responseData.meta || !responseData.timings) { console.log(`[VALIDASI GAGAL] Respons API tidak lengkap untuk kota: ${city}`); return null; } const validTimezones = ['Asia/Jakarta', 'Asia/Pontianak', 'Asia/Makassar', 'Asia/Jayapura']; if (!validTimezones.includes(responseData.meta.timezone)) { console.log(`[VALIDASI GAGAL] Zona waktu tidak valid (${responseData.meta.timezone}) untuk kota: ${city}`); return null; } return responseData; } catch (error) { console.log(`[API ERROR] Panggilan API gagal untuk kota: "${city}". Pesan: ${error.message}`); return null; } }
function formatUptime(startTime) { const now = Date.now(); let seconds = Math.floor((now - startTime) / 1000); let days = Math.floor(seconds / (24 * 3600)); seconds %= (24 * 3600); let hours = Math.floor(seconds / 3600); seconds %= 3600; let minutes = Math.floor(seconds / 60); seconds %= 60; return `${days} hari, ${hours} jam, ${minutes} menit, ${seconds} detik`; }
function calculateCountdown(timings) { const nowInJakarta = DateTime.now().setZone('Asia/Jakarta'); const prayerOrder = ['Fajr', 'Dhuhr', 'Asr', 'Maghrib', 'Isha']; let nextPrayerName = null; let nextPrayerTime = null; for (const prayerName of prayerOrder) { const prayerTimeStr = timings[prayerName]; if (!prayerTimeStr) continue; const [hour, minute] = prayerTimeStr.split(':'); let prayerDateTime = nowInJakarta.set({ hour: parseInt(hour), minute: parseInt(minute), second: 0, millisecond: 0 }); if (prayerDateTime > nowInJakarta) { nextPrayerName = prayerName; nextPrayerTime = prayerDateTime; break; } } if (!nextPrayerName) { nextPrayerName = 'Fajr'; const [hour, minute] = timings.Fajr.split(':'); nextPrayerTime = nowInJakarta.plus({ days: 1 }).set({ hour: parseInt(hour), minute: parseInt(minute), second: 0, millisecond: 0 }); } const diff = nextPrayerTime.diff(nowInJakarta, ['hours', 'minutes']).toObject(); const hours = Math.floor(diff.hours); const minutes = Math.floor(diff.minutes); const translatedPrayerName = PRAYER_NAMES_MAP[nextPrayerName] || nextPrayerName; return `⏳ *${hours} jam ${minutes} menit* lagi menuju sholat *${translatedPrayerName}*`; }
async function sendDailyVerse(sock, jid, isScheduled = false) { try { if (!isScheduled) { await sock.sendMessage(jid, { text: "📖 Tunggu sebentar, sedang mencari ayat untukmu..." }); } const randomAyat = Math.floor(Math.random() * 6236) + 1; const response = await axios.get(`https://api.alquran.cloud/v1/ayah/${randomAyat}/editions/quran-uthmani,id.indonesian,ar.alafasy,en.transliteration`); const data = response.data.data; const arabicData = data.find(d => d.edition.identifier === 'quran-uthmani'); const indonesianData = data.find(d => d.edition.identifier === 'id.indonesian'); const audioData = data.find(d => d.edition.identifier === 'ar.alafasy'); const transliterationData = data.find(d => d.edition.identifier === 'en.transliteration'); if (!arabicData || !indonesianData || !audioData || !transliterationData) { throw new Error("Data dari API tidak lengkap."); } const { text: arabicText, surah: { name: surahName, number: surahNumber }, numberInSurah: ayatNumber } = arabicData; const { text: translationText } = indonesianData; const { text: transliterationText } = transliterationData; const { audio: audioUrl } = audioData; const message = `*✨ AYAT AL-QUR'AN UNTUKMU HARI INI*\n\n*${surahName} (${surahNumber}:${ayatNumber})*\n\n*${arabicText}*\n\n*Bacaan Latin:*\n_${transliterationText}_\n\n*Artinya:*\n_"${translationText}"_\n\nSemoga menjadi pengingat yang bermanfaat 😊✨\n\n> © MUADZIN BOT`; await sock.sendMessage(jid, { text: message }); await sock.sendMessage(jid, { audio: { url: audioUrl }, ptt: true, mimetype: 'audio/mpeg' }); const stickerPath = './stickers/bacaquran.webp'; if (fs.existsSync(stickerPath)) { await sock.sendMessage(jid, { sticker: { url: stickerPath } }); } } catch (error) { console.error("[ERROR] Gagal mengirim ayat harian:", error.message); if (!isScheduled) { await sock.sendMessage(jid, { text: "Maaf, ada kendala saat mengambil ayat. Coba lagi nanti." }); } } }
async function sendAlKahfiReminder(sock, jid) { try { const surah = 18; const ayat = Math.floor(Math.random() * 110) + 1; const response = await axios.get(`https://api.alquran.cloud/v1/ayah/${surah}:${ayat}/editions/quran-uthmani,id.indonesian,ar.alafasy,en.transliteration`); const data = response.data.data; const arabicData = data.find(d => d.edition.identifier === 'quran-uthmani'); const indonesianData = data.find(d => d.edition.identifier === 'id.indonesian'); const audioData = data.find(d => d.edition.identifier === 'ar.alafasy'); const transliterationData = data.find(d => d.edition.identifier === 'en.transliteration'); if (!arabicData || !indonesianData || !audioData || !transliterationData) { throw new Error("Data Al-Kahfi dari API tidak lengkap."); } const { text: arabicText } = arabicData; const { text: translationText } = indonesianData; const { text: transliterationText } = transliterationData; const { audio: audioUrl } = audioData; const message = `*✨ JUM'AT MUBARAK - WAKTUNYA AL-KAHFI*\n\n_Dari Abu Sa’id Al-Khudri radhiyallahu ‘anhu, Nabi shallallahu ‘alaihi wa sallam bersabda:_\n_"Barangsiapa membaca surat Al-Kahfi pada hari Jum’at, maka ia akan disinari oleh cahaya di antara dua Jum’at."_\n\nBerikut adalah salah satu ayatnya (QS. Al-Kahfi: *${ayat}*):\n\n${arabicText}\n\n*Bacaan Latin:*\n_${transliterationText}_\n\n*Artinya:*\n_"${translationText}"_\n\n\n> © MUADZIN BOT`; await sock.sendMessage(jid, { text: message }); await sock.sendMessage(jid, { audio: { url: audioUrl }, ptt: true, mimetype: 'audio/mpeg' }); const stickerPath = './stickers/alkahfi.webp'; if (fs.existsSync(stickerPath)) { await sock.sendMessage(jid, { sticker: { url: stickerPath } }); } } catch (error) { console.error("[ERROR] Gagal mengirim pengingat Al-Kahfi:", error.message); } }
async function sendPrayerNotification(sock, jid, prayer, time, city, userName, timings) { try { const isGroup = isJidGroup(jid); const greeting = isGroup ? `Assalamualaikum semuanya! 🙏` : `Assalamualaikum *${userName}*! 🙏`; const translatedPrayerName = PRAYER_NAMES_MAP[prayer] || prayer; const countdownMessage = calculateCountdown(timings); const message = `*🕌 WAKTU SHOLAT TELAH TIBA 🕌*\n\n${greeting}\nSaat ini pukul *${time}* telah masuk waktu sholat *${translatedPrayerName.toUpperCase()}*\nuntuk wilayah ${city} dan sekitarnya.\n\n${countdownMessage}`; await sock.sendMessage(jid, { text: message }); const stickerPath = `./stickers/${prayer.toLowerCase()}.webp`; if (fs.existsSync(stickerPath)) { await sock.sendMessage(jid, { sticker: { url: stickerPath } }); } try { console.log(`[AZAN] Mengirim audio Azan ke ${jid} untuk sholat ${prayer}.`); const fajrAzanUrl = 'https://ia804603.us.archive.org/7/items/adhan_fajr_mansour_zahrani/adhan_fajr_mansour_zahrani.mp3'; const regularAzanUrl = 'https://cdn.aladhan.com/audio/adhans/a1.mp3'; const azanAudioUrl = (prayer === 'Fajr') ? fajrAzanUrl : regularAzanUrl; await sock.sendMessage(jid, { audio: { url: azanAudioUrl }, ptt: true, mimetype: 'audio/mpeg' }); } catch (audioError) { console.error(`[ERROR] Gagal mengirim audio Azan ke ${jid}:`, audioError); } const closingMessage = `Selamat menunaikan ibadah sholat *${translatedPrayerName.toUpperCase()}* 😊✨\n\n> © MUADZIN BOT`; await sock.sendMessage(jid, { text: closingMessage }); } catch (error) { console.error(`[ERROR] Gagal mengirim notifikasi lengkap untuk ${prayer} ke ${jid}:`, error); } }
async function sendDzikir(sock, jid, type) { try { const isPagi = type.toLowerCase() === 'pagi'; const text = isPagi ? DZIKIR_PAGI_TEXT : DZIKIR_PETANG_TEXT; const stickerPath = isPagi ? './stickers/dzikirpagi.webp' : './stickers/dzikirpetang.webp'; await sock.sendMessage(jid, { text: text }); if (fs.existsSync(stickerPath)) { await sock.sendMessage(jid, { sticker: { url: stickerPath } }); } } catch (error) { console.error(`[ERROR] Gagal mengirim dzikir ${type}:`, error.message); } }
async function scheduleRemindersForUser(sock, jid, city, userName) { if (scheduledJobs[jid]) scheduledJobs[jid].forEach(job => job.cancel()); scheduledJobs[jid] = []; const prayerData = await fetchPrayerTimes(city); if (!prayerData || !prayerData.timings) return; const timings = prayerData.timings; console.log(`[JADWAL] Mengatur alarm untuk ${jid} di kota ${city}`); for (const [prayer, time] of Object.entries(timings)) { if (['Fajr', 'Dhuhr', 'Asr', 'Maghrib', 'Isha'].includes(prayer)) { const [hour, minute] = time.split(':'); const rule = new schedule.RecurrenceRule(); rule.hour = parseInt(hour); rule.minute = parseInt(minute); rule.tz = 'Asia/Jakarta'; const job = schedule.scheduleJob(rule, async () => { const currentSubscriber = subscribers[jid]; const currentUserName = currentSubscriber ? currentSubscriber.name : 'Kawan'; const freshPrayerData = await fetchPrayerTimes(city); if (freshPrayerData && freshPrayerData.timings) { await sendPrayerNotification(sock, jid, prayer, time, city, currentUserName, freshPrayerData.timings); } }); if (job) scheduledJobs[jid].push(job); } } }

// --- BAGIAN 5: FUNGSI UTAMA BOT (STRUKTUR DIPERBAIKI) ---
async function connectToWhatsApp() {
    loadInitialData();
    let hasScheduledGlobalJobs = false; // Flag untuk memastikan jadwal global hanya diatur sekali
    ...
    sock.ev.on('connection.update', async (update) => {
        ...
        if (qr) {
            console.log('------------------------------------------------');
            console.log('       PAIRING CODE ANDA (SCAN DI WA)       ');
        ...
        if (connection === 'close') {
            ...
            if (!hasScheduledGlobalJobs) {
                console.log('[JADWAL GLOBAL] Mengatur jadwal pengiriman Ayat, Doa, Dzikir, dan Al-Kahfi...');

                const verseSchedule = new schedule.RecurrenceRule({ hour: [12, 18], minute: 40, tz: 'Asia/Jakarta' });
                schedule.scheduleJob(verseSchedule, async () => {
                    console.log(`[INFO] Mengirim Random Ayat berkala (WIB)`);
                    for (const jid in subscribers) {
                ...
                const wishSchedule = new schedule.RecurrenceRule({ hour: [9, 20], minute: 0, tz: 'Asia/Jakarta' });
                schedule.scheduleJob(wishSchedule, async () => {
                    console.log(`[INFO] Mengirim Doa & Harapan Harian (WIB)`);
                ...
                const dzikirPagiRule = new schedule.RecurrenceRule({ hour: 7, minute: 0, tz: 'Asia/Jakarta' });
                ...
                const dzikirPetangRule = new schedule.RecurrenceRule({ hour: 16, minute: 0, tz: 'Asia/Jakarta' });
                ...
                const alKahfiRule = new schedule.RecurrenceRule({ dayOfWeek: 5, hour: 8, minute: 0, tz: 'Asia/Jakarta' });
    ...
    sock.ev.on('messages.upsert', async (m) => {
        ...
        try {
            ...
            const now = Date.now();
            userActivity[from] = userActivity[from] || { timestamps: [] };
            ...
            if (userActivity[from].timestamps.length > SPAM_MESSAGE_LIMIT) {
                if (!blockedUsers.has(from)) {
                    await sock.sendMessage(from, { text: "Maaf, kamu terdeteksi melakukan spam. Nomor Kamu diblokir. Hubungi owner untuk membuka blokir." });
            ...
            if (userState[from]) {
                ...
                for (const prefix of prefixesToRemove) { if (sanitizedCity.startsWith(prefix)) { sanitizedCity = sanitizedCity.replace(prefix, '').trim(); break; } }
                if (sanitizedCity === '/kota') { await sock.sendMessage(from, { text: KOTA_LIST_TEXT }); return; }
                if (!KOTA_VALID.has(sanitizedCity)) { await sock.sendMessage(from, { text: `Maaf, kota *"${userInput}"* tidak kami kenali. Pastikan ejaan benar.\n\nKetik \`/kota\` untuk melihat daftar.` }); return; }
                const finalCityName = sanitizedCity.split(' ').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ');
                ...
                if (validCityData) {
                    ...
                    if (state === 'awaiting_city_subscribe') {
                        await sock.sendMessage(from, { text: `✅ Alhamdulillah, langganan berhasil diaktifkan untuk wilayah *${finalCityName}*.\n\nSemoga istiqomah dalam menjaga sholat tepat waktu. 🙏` }, { quoted: msg });
                        try { const totalSubscribers = Object.keys(subscribers).length; const ownerJid = `${OWNER_NUMBER}@s.whatsapp.net`; const notifMessage = `🔔 *LANGGANAN BARU*\n\n> Nama: ${subscriberName}\n> Nomor: ${from.split('@')[0]}\n> Kota: ${finalCityName}\n> Total: ${totalSubscribers}`; await sock.sendMessage(ownerJid, { text: notifMessage }); } catch (e) { console.error("[OWNER NOTIF ERROR] subscribe:", e); }
                    } else if (state === 'awaiting_city_change_location') {
                        await sock.sendMessage(from, { text: `✅ Lokasi berhasil diubah! Pengingat sekarang diatur untuk kota *${finalCityName}*.` }, { quoted: msg });
                    }
                    await scheduleRemindersForUser(sock, from, finalCityName, subscriberName);
                    delete userState[from];
                } else {
                    await sock.sendMessage(from, { text: `Maaf, terjadi kendala saat mengambil data untuk kota *${finalCityName}*. Coba beberapa saat lagi ya.` });
                }
                return;
            }
            ...
            switch (command) {
                ...
                case '/help':
                    ...
                    for (const jid of Object.keys(subscribers)) { isJidGroup(jid) ? totalGroupUsers++ : totalPersonalUsers++; }
                    await sock.sendMessage(from, { text: generateMenuText(userName, totalPersonalUsers, totalGroupUsers, isGroup) });
                    break;
                case '/aturpengingat':
                    if (subscribers[from]) {
                        await sock.sendMessage(from, { text: `🔔 *Kamu Sudah Berlangganan*\n\nPengingat sudah aktif untuk kota *${subscribers[from].city}*.\n\n- Ubah lokasi: \`/gantilokasi\`\n- Berhenti: \`/berhenti\`` }, { quoted: msg });
                    } else {
                        userState[from] = 'awaiting_city_subscribe';
                        await sock.sendMessage(from, { text: "Silakan ketik nama kota yang kamu inginkan.\n\nContoh: `Pekanbaru`\n\n_Untuk melihat daftar kota, ketik */kota*_" }, { quoted: msg });
                    }
                    break;
                case '/gantilokasi':
                    if (!subscribers[from]) {
                        await sock.sendMessage(from, { text: "Maaf, kamu belum berlangganan. Ketik `/aturpengingat` dulu ya." }, { quoted: msg });
                        return;
                    }
                    userState[from] = 'awaiting_city_change_location';
                    await sock.sendMessage(from, { text: `📍 Lokasi saat ini: *${subscribers[from].city}*.\n\nSilakan ketik nama kota baru.` }, { quoted: msg });
                    break;
                case '/berhenti':
                case '/unsubscribe':
                    if (subscribers[from]) {
                        ...
                        await sock.sendMessage(from, { text: "✅ Langganan berhasil diberhentikan.\n\nTerima kasih sudah menggunakan bot ini. Sampai jumpa lagi! 👋😊" }, { quoted: msg });
                        try {
                            const totalSubscribers = Object.keys(subscribers).length;
                            const ownerJid = `${OWNER_NUMBER}@s.whatsapp.net`;
                            const notifMessage = `🔕 *BERHENTI LANGGANAN*\n\n> Nama: ${unsubscriberData.name}\n> Nomor: ${from.split('@')[0]}\n> Kota: ${unsubscriberData.city}\n> Total Pelanggan: ${totalSubscribers}`;
                            await sock.sendMessage(ownerJid, { text: notifMessage });
                        } catch (e) {
                            console.error("[OWNER NOTIF ERROR] unsubscribe:", e);
                        }
                    } else {
                        await sock.sendMessage(from, { text: "Maaf, kamu memang belum berlangganan." }, { quoted: msg });
                    }
                    break;
                case '/jadwal':
                    const targetCity = cityArg || (subscribers[from] ? subscribers[from].city : null);
                    if (!targetCity) {
                        await sock.sendMessage(from, { text: "Ketik nama kota atau atur pengingat dulu.\n\n*Contoh:*\n`/jadwal Jakarta`\n\n*Atau mulai berlangganan:*\n`/aturpengingat`" }, { quoted: msg });
                        return;
                    }
                    const normalizedCity = targetCity.toLowerCase();
                    if (!KOTA_VALID.has(normalizedCity)) {
                        await sock.sendMessage(from, { text: `Maaf, kota *"${targetCity}"* tidak kami kenali.\n\nPastikan ejaan sudah benar. Lihat daftar di \`/kota\`` });
                        return;
                    }
                    ...
                    if (prayerDataToday && prayerDataToday.timings) {
                        ...
                        let scheduleMessage = `*🕌 JADWAL SHOLAT: ${targetCity}*\n*${prayerDataToday.date.gregorian.weekday.en}, ${gregorianDate.split('-').reverse().join('-')} | ${hijriDate}*\n*${serverTime} WIB*\n\n*Hari ini*\n` + `> Imsak: *${timingsToday.Imsak}*\n> Subuh: *${timingsToday.Fajr}*\n> Syuruk: *${timingsToday.Sunrise}*\n> Dzuhur: *${timingsToday.Dhuhr}*\n> Ashar: *${timingsToday.Asr}*\n> Ghurub: *${timingsToday.Sunset}*\n> Maghrib: *${timingsToday.Maghrib}*\n> Isya: *${timingsToday.Isha}*\n> ⅓ Malam Awal: *${timingsToday.Firstthird}*\n> Tengah Malam: *${timingsToday.Midnight}*\n> ⅓ Malam Akhir: *${timingsToday.Lastthird}*\n`;
                        if (prayerDataTomorrow && prayerDataTomorrow.timings) {
                            const timingsTomorrow = prayerDataTomorrow.timings;
                            scheduleMessage += `\n*Besok*\n` + `> Imsak: *${timingsTomorrow.Imsak}*\n> Subuh: *${timingsTomorrow.Fajr}*\n> Dzuhur: *${timingsTomorrow.Dhuhr}*\n> Ashar: *${timingsTomorrow.Asr}*\n> Maghrib: *${timingsTomorrow.Maghrib}*\n> Isya: *${timingsTomorrow.Isha}*\n`;
                        }
                        scheduleMessage += `\n${calculateCountdown(timingsToday)}\n\n> © MUADZIN BOT`;
                        await sock.sendMessage(from, { text: scheduleMessage }, { quoted: msg });
                    } else {
                        await sock.sendMessage(from, { text: `Maaf, gagal mengambil data untuk kota *${targetCity}*. Coba periksa lagi ejaannya.` });
                    }
                    break;
                case '/infobot':
                    const latency = (msg.messageTimestamp.low) ? (Date.now() - (msg.messageTimestamp.low * 1000)) : (Date.now() - (msg.messageTimestamp * 1000));
                    const uptime = formatUptime(botStartTime);
                    let info_totalPersonal = 0;
                    let info_totalGroup = 0;
                    for (const jid of Object.keys(subscribers)) { isJidGroup(jid) ? info_totalGroup++ : info_totalPersonal++; }
                    const infoText = `*🤖 INFORMASI BOT*\n\n*Nama Bot:* Muadzin Bot\n*Status:* Online\n*Aktif Sejak:* ${uptime}\n*Respon:* ${latency} ms\n*Pengguna:* ${info_totalPersonal} | *Grup:* ${info_totalGroup}\n\n> © MUADZIN BOT`;
                ...
                case '/donasi':
                    try {
                        ...
                        await sock.sendMessage(from, { text: "Maaf, gagal memuat gambar donasi.\n\n" + DONASI_TEXT });
                    }
                    break;
                case '/owner':
                ...
                case '/broadcast':
                    ...
                    if (command === '/testnotif') { 
                        if (!subscribers[from]) { await sock.sendMessage(from, { text: "Anda harus subscribe dulu." }); return; }
                        let prayerToTest = args[0]?.toLowerCase();
                        if (prayerToTest === 'subuh') prayerToTest = 'fajr'; else if (prayerToTest === 'dzuhur') prayerToTest = 'dhuhr'; else if (prayerToTest === 'ashar') prayerToTest = 'asr';
                        const validPrayers = ['fajr', 'dhuhr', 'asr', 'maghrib', 'isha'];
                        if (!prayerToTest || !validPrayers.includes(prayerToTest)) { await sock.sendMessage(from, { text: `Gunakan: \`/testnotif <nama_sholat>\`` }); return; }
                        const userCity = subscribers[from].city; const testPrayerData = await fetchPrayerTimes(userCity);
                        if (testPrayerData && testPrayerData.timings) {
                            const prayerNameAPI = prayerToTest.charAt(0).toUpperCase() + prayerToTest.slice(1);
                            await sock.sendMessage(from, { text: `OK, tes notifikasi *${PRAYER_NAMES_MAP[prayerNameAPI].toUpperCase()}*...` });
                            await sendPrayerNotification(sock, from, prayerNameAPI, testPrayerData.timings[prayerNameAPI], userCity, subscribers[from].name, testPrayerData.timings);
                        }
                    }
                    if (command === '/testdzikir') { 
                        const dzikirType = args[0]?.toLowerCase();
                        if (dzikirType === 'pagi' || dzikirType === 'petang') { await sock.sendMessage(from, { text: `OK, tes Dzikir *${dzikirType.toUpperCase()}*...` }); await sendDzikir(sock, from, dzikirType); } 
                        else { await sock.sendMessage(from, { text: `Gunakan: \`/testdzikir <pagi/petang>\`` }); }
                    }
                    if (command === '/testalkahfi') { await sock.sendMessage(from, { text: `OK, tes Al-Kahfi...` }); await sendAlKahfiReminder(sock, from); }
                    if (command === '/testdoa') { 
                        await sock.sendMessage(from, { text: "OK, tes Doa Harian..." });
                        const randomWish = DOA_HARIAN[Math.floor(Math.random() * DOA_HARIAN.length)];
                        const messageToSend = `*✨ PESAN KEBAIKAN UNTUKMU ✨*\n\n_${randomWish}_\n\n> © MUADZIN BOT`;
                    ...
                    if (command === '/broadcast') { 
                        ...
                        let broadcastMessageContent = args.join(' '); let mediaBuffer = null; let mediaType = null;
                        if (isMediaMsg) { mediaType = msg.message.imageMessage ? 'image' : 'video'; mediaBuffer = await downloadMediaMessage(msg, 'buffer', {}, { logger: pino({ level: 'silent' }) }); broadcastMessageContent = body.substring('/broadcast'.length).trim(); } 
                        else if (replied?.conversation) { broadcastMessageContent = replied.conversation; }
                        if (!broadcastMessageContent && !mediaBuffer) { await sock.sendMessage(from, { text: `Gunakan:\n1. \`/broadcast <pesan>\`\n2. Reply pesan, ketik \`/broadcast\`\n3. Kirim media dengan caption \`/broadcast <pesan>\`` }); return; }
                        ...
                        for (const jid of subscriberJids) {
                            try {
                                let finalMessage = {}; const formattedCaption = `📢 *BROADCAST*\n\n${broadcastMessageContent}\n\n> Admin ARH`;
                                if (mediaBuffer && mediaType) { finalMessage[mediaType] = mediaBuffer; finalMessage.caption = formattedCaption; } else { finalMessage = { text: formattedCaption }; }
                                await sock.sendMessage(jid, finalMessage); await new Promise(resolve => setTimeout(resolve, 1000));
                            } catch (e) { console.error(`[BROADCAST ERROR] Gagal ke ${jid}:`, e.message); }
                        }
                ...
                default:
                    if (command.startsWith('/')) {
                        ...
                        let timeOfDayEmoji = "";
                        if (hour >= 4 && hour < 10) { timeOfDayGreeting = "Selamat pagi"; timeOfDayEmoji = "☀️"; } else if (hour >= 10 && hour < 15) { timeOfDayGreeting = "Selamat siang"; timeOfDayEmoji = "🌤️"; } else if (hour >= 15 && hour < 18) { timeOfDayGreeting = "Selamat sore"; timeOfDayEmoji = "🌇"; } else { timeOfDayGreeting = "Selamat malam"; timeOfDayEmoji = "🌙"; }
                        const randomWish = DOA_HARIAN[Math.floor(Math.random() * DOA_HARIAN.length)];
                        const welcomeMessageText = `Ahlan wa Sahlan *${userName}*! ${timeOfDayGreeting} ${timeOfDayEmoji}\n\nAku Muadzin Bot, asisten pengingat waktu sholat mu ✨\n\nUntuk memulai, silakan gunakan \`/menu\`.\n\n_${randomWish}_\n\n> © MUADZIN BOT`;
    ...
    }); // --- Akhir dari sock.ev.on('messages.upsert') ---

} // --- Akhir dari fungsi connectToWhatsApp ---

// --- BAGIAN 6: SERVER KEEP-ALIVE & EKSEKUSI BOT ---
...
// Kode auto-restart saat file bot.js berubah
